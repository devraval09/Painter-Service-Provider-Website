<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="detail.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <div class="pt-2">
                        <a href="index.aspx" class="btn btn-secondary rounded-pill py-2 px-4 mx-2">Home</a>
